    ...
    <div id="layer" class="container">
      ...
      <div class="row">
        ...
        <div id="workshop-sub" class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
          <div  id="mozilla" data-toggle="modal" data-target=".mozilla"><img id="workshop1" class="level3" src="svg/firefox.svg"/></div>
      ...
      <div class="row">
        ...
        <div id="brain-sub" class="col-lg-11 col-md-11 col-sm-11 col-xs-11">
          ...
          <div id="crypto" data-toggle="modal" data-target=".Antagon"><img class="level6" src="svg/antagon.svg"/></div>
